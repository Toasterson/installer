...
pub struct InfoResponse {
    ...
    #[prost(string, tag = "2")]
    pub machinepass: ::prost::alloc::string::String,
    #[prost(string, tag = "3")]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn info(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/machined.MachineService/Info",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("machined.MachineService", "Info"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/machined.MachineService/Info" => {
                    ...
                    struct InfoSvc<T: MachineService>(pub Arc<T>);
                    impl<
                        T: MachineService,
                    > tonic::server::UnaryService<super::InfoRequest> for InfoSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as MachineService>::info(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
